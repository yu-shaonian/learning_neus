...
from lib.networks.neus.SDF import RenderingNetwork, SDFNetwork, SingleVarianceNetwork, NeRF
...
class Network(nn.Module):
    def __init__(self):
        ...
        self.n_samples = net_cfg.n_samples
        self.n_importance = net_cfg.n_importance
